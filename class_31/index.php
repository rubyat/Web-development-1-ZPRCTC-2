...
?>
	  		...
	  		<div class="row">
	  			<div class="col-md-6 ml-auto mr-auto">
	  				<div class="section_title  text-center">
						...
						?>
	  					<h2><?php echo $product_page['title'];?></h2>
	  				</div>
	  				<div class="row">
	  ...
	  <?php
		...
		$sql = "SELECT * FROM page WHERE page_id = 3";
		$result = $conn->query($sql);
		$paralux = $result->fetch_assoc();
	
	?>
	  <section class="paralux_area">
	  	<div class="paralux" style="background-image:url('uploads/<?php echo $paralux['image'];?>')">
	  		<div class="container">
	  			<div class="row">
	  				<div class="col-md-5">
	  	...
	  	<div class="container">
	  		<div class="row">
	  			<div class="col-md-10 offset-md-1">
	  				...
	  				<div class="details_area text-center"><?php echo $news_page['details'];?></div>
	  ...
	  <?php
			...
			$sql = "SELECT * FROM page WHERE page_id = 5";
			$result = $conn->query($sql);
	  ...
	  <section class="banner_area">
	  	<div class="banner">
	  		<img src="uploads/<?php echo $contact_page['image'];?>" alt="">
